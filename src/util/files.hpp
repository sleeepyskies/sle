...
// ------------ file path handling --------------
/**
 * @brief Fetches the filename from assets/textures.
 ...
 */
inline fs::path fetchTexture(const std::string& fileName, const std::string& fileExtension = "png") {
    return ASSETS_PATH / "textures" / (fileName + "." + fileExtension);
}
