...
template <typename T> void ComponentManager::registerComponent(const Entity entity, const IComponent &component) {
...
template <typename T> void ComponentManager::unregisterComponent(const Entity entity) {
...
template <typename T> ref<T> ComponentManager::getComponent(const Entity entity) {
